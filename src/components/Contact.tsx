    ...
    <div className="bg-gray-50 dark:bg-neutral-900" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 text-center">
        ...
        <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-neutral-400">
            ...
            <a href="mailto:kamoellenkganakga@gmail.com">kamoellenkganakga@gmail.com</a>
          </div>

          <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-neutral-400">
            <PhoneIcon className="w-4 h-4" />
            <a href="tel:+27 6910 35501">+27 6910 35501</a>
  ...
  return (
    <div className="bg-gray-50 dark:bg-neutral-900" id="contact">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
        <div>
          <h2 className="text-lg font-bold">Contact FitTry</h2>
          <p className="max-w-sm mt-4 mb-4 dark:text-neutral-400">
            Have something to say? You can fill out the contact form and our support team will get back to you shortly.
          </p>
          ...
          <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-neutral-400">
            <EnvelopeIcon className="w-4 h-4" />
            <a href="mailto:kamoe@gmail.com">kamoellenkganakga@gmail.com</a>
          </div>
        ...
        <div>
          {!isSubmitSuccessful && (
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <input type="hidden" value="FitTry" {...register("from_name")} />
              <input
                type="checkbox"
                id=""
                className="hidden"
              ...
              <div className="mb-5">
                <input
                  ...
                  className={`w-full px-4 py-3 border-2 placeholder:text-neutral-800 dark:text-white rounded-md outline-none dark:placeholder:text-neutral-200 dark:bg-neutral-900 focus:ring-4 ${
                    errors.name
                      ? "border-green-500 focus:border-green-500 ring-green-100 dark:ring-0"
          ...
          {isSubmitSuccessful && isSuccess && (
            <>
              <div className="flex flex-col items-center justify-center text-center text-white rounded-md">
                ...
                <button
                  className="mt-6 py-2 px-4 bg-green-500 rounded-full focus:outline-none text-neutral-100"
                  onClick={() => reset()}
                >
                  Go back
                </button>
    ...
    <div className="bg-gray-50 dark:bg-neutral-900" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 text-center">
        ...
        <p className="pt-6 pb-6 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
          ...
          you how FitTry can transform her FitTrys web experience.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
        <div>
          ...
          <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-neutral-400">
            <PhoneIcon className="w-4 h-4" />
            <a href="tel:51931999999">+number</a>
          </div>
        </div>
